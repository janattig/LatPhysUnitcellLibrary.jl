...
function getUnitcell_8_3_n(
	...
	return newUnitcell(
		...
		# sites
		S[
			newSite(S, x*a + (0.5 - x)*b + c/4., getDefaultLabelN(LS,1)),
			newSite(S, (1-x)*a + (0.5 - x)*b + c/4., getDefaultLabelN(LS,2)),
			newSite(S, (0.5 + x)*a + b/2. + (0.5 - z)*c, getDefaultLabelN(LS,3)),
			newSite(S, (1-x)*a + (0.5 + x)*b + c/4., getDefaultLabelN(LS,4)),
			newSite(S, x*a + (0.5 + x)*b + c/4., getDefaultLabelN(LS,5)),
			newSite(S, (0.5 - x)*a + b/2. + (0.5 - z)*c, getDefaultLabelN(LS,6)),
			newSite(S, (1-x)*b + z*c, getDefaultLabelN(LS,7)),
			newSite(S, x*b + z*c, getDefaultLabelN(LS,8)),
			newSite(S, (0.5 - x)*a + x*b + c/4., getDefaultLabelN(LS,9)),
			newSite(S, a/2. + (0.5 - x)*b + (0.5 - z)*c, getDefaultLabelN(LS,10)),
			newSite(S, (0.5 + x)*a + x*b + c/4., getDefaultLabelN(LS,11)),
			newSite(S, (0.5 + x)*a + (1 - x)*b + c/4., getDefaultLabelN(LS,12)),
			newSite(S, a/2. + (0.5 + x)*b + (0.5 - z)*c, getDefaultLabelN(LS,13)),
			newSite(S, (0.5 - x)*a + (1 - x)*b + c/4., getDefaultLabelN(LS,14)),
